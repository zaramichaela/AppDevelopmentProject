...
class items_controller:
    def __init__(self):
        ...
        self._all_coupons = cfactory.get_all_coupons_db()
        self._all_items = sfactory.get_all_items_db()
        self._all_packages = sfactory.get_all_packages_db()
        self._all_services = sfactory.get_all_services_db()
        self._all_suppliers = sfactory.get_all_suppliers_db()
